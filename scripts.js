...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const text = 'Web Developer • Tech Builder • Digital Strategist';
    let index = 0;
...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll(
        '.tech-category, .project-card, .contact-method, .about-text, .testimonial-content'
    );
...
// Add loaded class styles for smooth transitions
